      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="hero-content mx-auto max-w-3xl text-center md:text-left">
          ...
          <p className="animate-on-scroll fade-in delay-3 mb-10 max-w-xl mx-auto md:mx-0 text-lg leading-relaxed text-text-secondary"> {/* text-lg, leading-relaxed */}
            Graduando em Ciência de Dados e Técnico em Informática, combino conhecimentos de Product Management, Business Intelligence, desenvolvimento e liderança para criar soluções data-driven. Aberto a oportunidades para aplicar e expandir meu potencial em projetos inovadores.
          </p>
          {/* ===== FIM DA ATUALIZAÇÃO ===== */}
